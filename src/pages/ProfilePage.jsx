...
import { getUser, getUserRef, updateUser, uploadImage } from '../Firebase'; // Ensure this imports the function to update the user in Firestore
...
function ProfilePage() {
    ...
    const triggerRefresh = () => {
        setRefresh(prev => !prev); // This will toggle the refresh state and trigger useEffect in OrgNavbar
    };
